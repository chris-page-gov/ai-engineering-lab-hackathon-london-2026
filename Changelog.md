...
- 2026-07-01: Ignored local `.playwright-mcp/` browser automation logs so live viewer smoke checks do not dirty publication branches.
...
- 2026-07-01: Hardened the GOV.UK CKAN static viewer against transient GitHub Pages JSON chunk failures by retrying 429/5xx fetches with cache-busting and lowering chunk fetch concurrency.
...
- 2026-07-01: Verified the reported live `resources-0138.json` chunk recovered from a transient GitHub Pages `503` and shipped viewer fetch retries to reduce demo risk.
...
- 2026-06-27: Changed the generated wiki viewer so the left navigation can collapse into a narrow current-page rail, preserving screen width for the graph and Markdown reader.
...
- 2026-05-13: Added generated start-to-finish Markdown conversation readers for the private and public Codex postmortem outputs, linked from the public postmortem index, conversation summaries, source notes, and per-exchange previous/next navigation.
...
- 2026-05-13: Documented the postmortem reader workflow, curated-session publication boundary, and absence of a separate repo skill across `README.md`, `Context.md`, `Progress.md`, and the generated postmortem operating docs.
