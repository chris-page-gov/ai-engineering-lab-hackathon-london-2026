...
- `research/hmrc-beyond-hype/narrative/index.md`: GitHub-browsable entry point for the HMRC talk narrative scaffold, linking the overview, narrative arc, topic index, source-material register, visual coverage report, validation report, sidecars, and ClawPilot sidebar.
