...
- `research/hmrc-beyond-hype/transcripts/`: committed Whisper transcript text, SRT timings, pyannote diarization evidence, and `Speaker 1` / `Speaker 2` review drafts for the imported audio.
