...
- `scripts/build_gov_ckan_bundle.py`: harvests paginated CKAN `package_search` metadata, normalises datasets/resources/publishers/facets/relationships, strips CKAN HTML metadata to readable text in the generated viewer, escapes CKAN-controlled metadata, and writes the generated `gov-ckan/` bundle.
